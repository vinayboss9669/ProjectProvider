...
![Visitors](https://api.visitorbadge.io/api/Visitors?path=developers-capstone%2FEduLinkUp%20&countColor=%23263759&style=flat)
![GitHub Forks](https://img.shields.io/github/forks/developers-capstone/EduLinkUp)
![GitHub Repo Stars](https://img.shields.io/github/stars/developers-capstone/EduLinkUp)
![GitHub Contributors](https://img.shields.io/github/contributors/developers-capstone/EduLinkUp)
![GitHub Last Commit](https://img.shields.io/github/last-commit/developers-capstone/EduLinkUp)
![GitHub Repo Size](https://img.shields.io/github/repo-size/developers-capstone/EduLinkUp)
![Github](https://img.shields.io/github/license/developers-capstone/EduLinkUp)
![GitHub Issues](https://img.shields.io/github/issues/developers-capstone/EduLinkUp)
![GitHub Closed Issues](https://img.shields.io/github/issues-closed-raw/developers-capstone/EduLinkUp)
![GitHub Pull Requests](https://img.shields.io/github/issues-pr/developers-capstone/EduLinkUp)
![GitHub Closed Pull Requests](https://img.shields.io/github/issues-pr-closed/developers-capstone/EduLinkUp)
 </p>
 </div>

<div align="center">
  <img src="Home.jpg" alt="EduLinkUp main dashboard interface with pink theme showing welcome message and navigation options" width="600"/>
  <br>
</div>
...
[![Contributors](https://contrib.rocks/image?repo=developers-capstone/EduLinkUp)](https://github.com/developers-capstone/EduLinkUp/graphs/contributors)

<p>
  <!-- Vaunt.dev (auto-updating SVG contributors graph) -->
  <a href="https://github.com/developers-capstone/EduLinkUp/graphs/contributors">
    <img 
      src="https://api.vaunt.dev/v1/github/entities/developers-capstone/repositories/EduLinkUp/contributors?format=svg&limit=54" 
      width="900" 
      height="400" 
